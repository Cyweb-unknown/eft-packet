...
// Custom loot files seperated from loot.hpp
        ...
        if (tk::g_state && tk::g_state->map)
        {
            ...
            if (tk::Observer* player = tk::g_state->map->get_player(); player)
            {
                ...
                auto draw_loot = [&](tk::LootEntry* entry, bool include_equipment = true)
                {
                    ...
                    if (healthItems.count(entry->name)) //green
                    {
                        r = 0;
                        g = 255;
                        b = 0;
                        ...
                        draw_beam = true;
                        draw_text = true;
                        name = healthItems[entry->name].c_str();
                    }
                    if (drinkItems.count(entry->name)) //lightblue
                    {
                        r = 153;
                        g = 204;
                        b = 255;
                        ...
                        draw_beam = true;
                        draw_text = true;
                        name = drinkItems[entry->name].c_str();
                    }
                    if (coolItems.count(entry->name)) //blue
                    {
                        r = 0;
                        g = 0;
                        b = 240;
                        ...
                        draw_beam = true;
                        draw_text = true;
                        name = coolItems[entry->name].c_str();
                    }

                    if (realcoolItems.count(entry->name)) //red
                    {
                        r = 255;
                        g = 0;
                        b = 0;
                        ...
                        draw_beam = true;
                        draw_text = true;
                        name = realcoolItems[entry->name].c_str();
                    }
                    ...
                    if (float distance = glm::length(entry_pos - player_pos); distance >= MIN_DISTANCE_FOR_LOOT)
                    {
                        if (draw_text)
                        {
                            loot_text_to_render.push_back(std::make_tuple(entry->pos, name, r, g, b));
                        }
